		...
		try {
			...
			while (rowsremaining > 0 && rs.next()) {
				...
				for (int i=0; i < rs.getMetaData().getColumnCount(); i++) {
					...
					EdmElement element = entitytype.getProperty(propertyname);
					JDBCType datatype = ODataUtils.getJDBCDataType(element.getType());
					Object value;
					if (datatype != null) {
						switch (datatype) {
						case BIGINT:
							...
							if (value instanceof BigDecimal) {
								/*
								 * Snowflake returns a BigDecimal for whatever reason when calling getObject()
								 */
								BigDecimal d = (BigDecimal) value;
								value = d.toBigInteger();
							}
						...
						case TIME: // 10:00:00
							...
							row.addProperty(new Property(null, propertyname, ValueType.PRIMITIVE, value));
							break;
						case TIMESTAMP:// 2009-12-31T23:00:00Z
						...
						throw new AppContainerSQLException("No data type found for oData element \"" + columnname + 
