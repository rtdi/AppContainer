...
/**
 * Application Lifecycle Listener implementation class HanaSessionListener
 *
 */
@WebListener
public class HanaSessionListener implements HttpSessionListener {
	protected final Logger log = LogManager.getLogger(this.getClass().getName());

    public HanaSessionListener() {
    }
