package io.rtdi.appcontainer.designtimeobjects.hdbtable;
...
import io.rtdi.appcontainer.antlr.sql.HDBTableBaseListener;
...
import io.rtdi.appcontainer.objects.table.subelements.IndexDefinition;
import io.rtdi.appcontainer.objects.table.subelements.IndexType;
import io.rtdi.appcontainer.objects.table.subelements.Order;
import io.rtdi.appcontainer.objects.table.subelements.PrimaryKeyDefinition;
import io.rtdi.appcontainer.objects.table.subelements.TableLoggingType;
import io.rtdi.appcontainer.objects.table.subelements.TableType;
import io.rtdi.appcontainer.objects.table.subelements.TemporaryType;
...
public class ANTLRHDBTableSetter extends HDBTableBaseListener {
	...
	public void enterSchemaname(SchemanameContext ctx) {
		ParseTree t = ctx.getChild(2);
		if (t != null) {
			// TODO: Warning // hdbtable.setSchemaName(Util.trimQuotes(t.getText()));
		}
	}
