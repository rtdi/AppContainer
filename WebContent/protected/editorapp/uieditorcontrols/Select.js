		...
		"io.rtdi.hanaappcontainer.editorapp.uieditorcontrols.Select", {
			...
			init : function() {
				...
				oModel.setData({ "list": [
					...
					{ "propertyname": "wrapItemsText" },
					{ "propertyname": "autoAdjustWidth" },
			...
			setItemIcon : function(value) {
				this.setProperty("itemIcon", value, true);
				this._updateAllItems("setIcon", value);
			},
			getParentProperties : function() {
				return sap.m.Select.prototype.getMetadata.apply(this, arguments).getAllProperties();
			},
			getParentAggregations : function() {
				return sap.m.Select.prototype.getMetadata.apply(this, arguments).getAllAggregations();
			},
			getParentAssociations : function() {
				return sap.m.Select.prototype.getMetadata.apply(this, arguments).getAllAssociations();
			},
			getParentClassName : function() {
				return sap.m.Select.prototype.getMetadata.apply(this, arguments).getName();
			}
