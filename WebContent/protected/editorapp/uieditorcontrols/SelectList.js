sap.ui.define(
  ...
  return sap.m.SelectList.extend(
		"io.rtdi.hanaappcontainer.editorapp.uieditorcontrols.SelectList", {
			...
			renderer : {},
			init : function() {
				sap.m.SelectList.prototype.init.apply(this, arguments);
			...
			getParentProperties : function() {
				return sap.m.SelectList.prototype.getMetadata.apply(this, arguments).getAllProperties();
			},
			getParentAggregations : function() {
				return sap.m.SelectList.prototype.getMetadata.apply(this, arguments).getAllAggregations();
			},
			getParentAssociations : function() {
				return sap.m.SelectList.prototype.getMetadata.apply(this, arguments).getAllAssociations();
			},
			getParentClassName : function() {
				return sap.m.SelectList.prototype.getMetadata.apply(this, arguments).getName();
			}
