sap.ui.define(
  ...
  return sap.m.MultiComboBox.extend(
		"io.rtdi.hanaappcontainer.editorapp.uieditorcontrols.MultiComboBox", {
			metadata : {
				...
				properties: {
					propertiesModel: { type: "sap.ui.model.json.JSONModel", defaultValue: null },
			...
			getParentProperties : function() {
				return sap.m.MultiComboBox.prototype.getMetadata.apply(this, arguments).getAllProperties();
			},
			getParentAggregations : function() {
				return sap.m.MultiComboBox.prototype.getMetadata.apply(this, arguments).getAllAggregations();
			},
			getParentAssociations : function() {
				return sap.m.MultiComboBox.prototype.getMetadata.apply(this, arguments).getAllAssociations();
			},
			getParentClassName : function() {
				return sap.m.MultiComboBox.prototype.getMetadata.apply(this, arguments).getName();
			}
