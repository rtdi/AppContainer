...
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.AliasContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.BeginendContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.BeginstartContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.BlockcommentContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.BquotedContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.CommandblockContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.DeclarestartContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.DirectiveContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.DirectiveconditionContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.DirectiveendContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.DquotedContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.ExtraContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.ForendContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.ForstartContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.IdentifierContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.IfendContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.IfstartContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.LinecommentContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.LoopendContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.LoopstartContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.ParamclauseendContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.ParamclausestartContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.ScriptContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.SemiContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.SquotedContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.StatementContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.TextContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.VariableContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.WhileendContext;
import io.rtdi.appcontainer.plugins.databasepostgresql.activation.antlr.SqlscriptsParser.WhilestartContext;
