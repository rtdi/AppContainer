...
public class SqlscriptsParser extends Parser {
	...
	public static final int
		...
		RULE_dollarblock = 27, RULE_extra = 28, RULE_semi = 29, RULE_text = 30, 
		RULE_escapedchar = 31, RULE_command = 32, RULE_commandblock = 33, RULE_statement = 34, 
		RULE_paramclause = 35, RULE_paramclausestart = 36, RULE_paramclauseend = 37, 
		RULE_param_list = 38, RULE_script = 39;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"whileend", "loopblock", "loopstart", "loopend", "dollarblock", "extra", 
			"semi", "text", "escapedchar", "command", "commandblock", "statement", 
			"paramclause", "paramclausestart", "paramclauseend", "param_list", "script"
		};
	}
	...
	public final SquotedContext squoted() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1069547518L) != 0) {
				{
				setState(102);
				_errHandler.sync(this);
	...
	public final BeginblockContext beginblock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1040170970L) != 0) {
				{
				{
				setState(242);
				statement();
	...
	public final DollarblockContext dollarblock() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_dollarblock);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ExtraContext extra() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_extra);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final SemiContext semi() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_semi);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(372);
	...
	public final EscapedcharContext escapedchar() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_escapedchar);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(387);
	...
	public final CommandContext command() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_command);
		try {
			setState(407);
			_errHandler.sync(this);
	...
	public final CommandblockContext commandblock() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_commandblock);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1039646682L) != 0) {
				{
				setState(411);
				_errHandler.sync(this);
	...
	public final ParamclauseContext paramclause() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_paramclause);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(435);
	...
	public final ParamclausestartContext paramclausestart() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_paramclausestart);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final ParamclauseendContext paramclauseend() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_paramclauseend);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
